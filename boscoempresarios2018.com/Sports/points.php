...
if($division!=null)
{
    echo "jhol no jholnever jhol";
}
else
{
    echo "always neverjhol";
}
...
function display(){
  ...
  {
    $pulldown = "SELECT * FROM participants WHERE event_1='".$event."' AND division='".$division."' ORDER BY id DESC";
    ...
    $pulldown = "SELECT * FROM participants WHERE event_2='".$event."' AND division='".$division."' ORDER BY id DESC";
    $result_pulldown = mysqli_query($con,$pulldown);
    while($data=mysqli_fetch_assoc($result_pulldown)){
      extract($data);
      $cat_value=$data['id'];
    ...
    $pulldown = "SELECT * FROM participants WHERE event_3='".$event."' AND division='".$division."' ORDER BY id DESC";
    $result_pulldown = mysqli_query($con,$pulldown);
    while($data=mysqli_fetch_assoc($result_pulldown)){
      extract($data);
      $cat_value=$data['id'];
    ...
    $pulldown = "SELECT * FROM participants WHERE event_4='".$event."' AND division='".$division."' ORDER BY id DESC";
    $result_pulldown = mysqli_query($con,$pulldown);
    while($data=mysqli_fetch_assoc($result_pulldown)){
      extract($data);
      $cat_value=$data['id'];
    ...
    $pulldown = "SELECT * FROM participants WHERE event_5='".$event."' AND division='".$division."' ORDER BY id DESC";
    $result_pulldown = mysqli_query($con,$pulldown);
    while($data=mysqli_fetch_assoc($result_pulldown)){
      extract($data);
      $cat_value=$data['id'];
